...
- códigos oficiales (`2027-1`, `T568-A`, `RJ-45`, `FODO-05`)
- listas y tablas de Markdown (`- item`, `| --- |`)
- el nombre de Michelle Paola Gonzalez Martines tal como está
...
Antes de dar por cerrado un cambio de texto: revisar acentos y rayas, y que los enlaces existan.
